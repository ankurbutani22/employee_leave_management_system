...
function seedLeaves() {
  ...
  if (!raw) {
    const seed = [
      { id: 1, employee: 'Alice', days: 2, status: 'pending', reason: 'Sick leave' },
      { id: 2, employee: 'Bob', days: 4, status: 'approved', reason: 'Vacation' },
    ]
    localStorage.setItem('leaves', JSON.stringify(seed))
    return seed
  }
